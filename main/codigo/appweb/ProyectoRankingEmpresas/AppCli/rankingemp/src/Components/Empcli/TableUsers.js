...
const {user, setUser}=useContext(UserContext);
  ...
  const [update, setUpdate] = React.useState(true);
    const ListUser = async (id) => {
      setSelected([]);
        var list = await UserService.getListUser(id)
        setListU(list)
  ...
  component="label"
>
  Descargar <i className="bi bi-file-earmark-excel"></i>
  <input
    type="file"
    hidden
  />
  ...
  component="label"
>
  Subir cargos <InsertDriveFileIcon></InsertDriveFileIcon>
  <input
    type="file"
    hidden
  />
      ...
      <Table size="small">
        <TableHead>
          ...
          <TableRow>
            ...
            <TableCell>Total Mopnetario bruto sin beneficios de ley</TableCell>
        ...
        <TableBody>
              ...
              .slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                     ...
                     >
                      ...
                      <TableCell>{listU.code}</TableCell>
